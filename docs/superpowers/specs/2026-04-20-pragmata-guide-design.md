...
Quick actions
  ...
  - Только сюжет
  - Скрыть спойлеры
  - Чеклист 100%  ← всегда активна, scroll к #checklist-100; без achievement-modal из Hades II
...
| `docs/guides/pragmata-guide/cover.webp` | Placeholder (пустой или заглушка) |
